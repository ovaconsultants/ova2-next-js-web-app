    ...
    weeks: [
      {
        ...
        objective:
          'Familiarize participants with React and set up the development environment.',
        description: [
      ...
      },
      {
        ...
        description: ['React Router', 'Forms in React', 'Form Validation'],
        assignments: [
      ...
      },
      {
        ...
        objective:
          'Dive into advanced Redux concepts and complete a final project.',
        description: [
          'Redux DevTools',
          'Combining Reducers',
    ...
    weeks: [
      {
        ...
        objective:
          'Understand the basics of Power BI and connecting to various data sources.',
        description: [
      ...
      },
      {
        ...
        objective:
          'Learn how to share reports and collaborate with others in Power BI.',
        description: [
  ...
  sqlTraining: {
    ...
    weeks: [
      ...
      },
      {
        ...
        objective:
          'Write complex SQL queries using subqueries, set operations, and case statements.',
        description: [
      ...
      },
      {
        ...
        objective:
          'Understand the basics of PL/SQL and creating stored procedures.',
        description: [
      ...
      },
      {
        ...
        objective:
          'Learn about triggers, views, and handling transactions in SQL.',
        description: [
      ...
      },
      {
        ...
        objective:
          'Master advanced PL/SQL concepts and complete the final project.',
        description: [
    ...
    weeks: [
      {
        ...
        objective:
          'Get familiar with Java basics and set up the development environment.',
        description: [
      ...
      },
      {
        ...
        objective:
          'Understand the basics of OOP and how to implement it in Java.',
        description: [
      ...
      },
      {
        ...
        objective:
          'Learn how to handle exceptions and perform file input/output operations in Java.',
        description: [
      ...
      },
      {
        ...
        objective:
          'Learn multithreading concepts and complete the final project.',
        description: [
  ...
  uiTraining: {
    ...
    weeks: [
      ...
      },
      {
        ...
        objective:
          'Learn JavaScript and how to add interactivity to web pages.',
        description: [
      ...
      },
      {
        ...
        objective:
          'Apply your knowledge to build a fully functional web application.',
        description: [
